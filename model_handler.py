    ...
    def train(self) -> Tuple[np.array, np.array, float]:
        ...
        for epoch in range(self.epochs):
            ...
            if (epoch + 1) % self.args.valid_epochs == 0:
                ...
                auc_val, recall_val, f1_mac_val, precision_val = test(model, self.dataset['valid_loader'], self.result,
                                                                      epoch, epoch_best, flag="val")
        ...
        auc_test, recall_test, f1_mac_test, precision_test = test(model, self.dataset['test_loader'], self.result,
                                                                  epoch, epoch_best, flag="test")
